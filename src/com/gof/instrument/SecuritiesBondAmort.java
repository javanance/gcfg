...
@Getter
@Setter
public class SecuritiesBondAmort extends SecuritiesBondAbstract {	

	public SecuritiesBondAmort(LocalDate baseDate) {		
		super();		
		this.baseDate = baseDate;
	}
	
	public SecuritiesBondAmort(Integer scenNum, Map<String, IrCurveHis> scenarioCurveHis) {		
		super(scenNum, scenarioCurveHis);			
	}	 

	public SecuritiesBondAmort() {
		super();		
	}
	...
	protected void setAttributes() throws Exception {
		...
		switch(EInstrument.getEInstrument(String.valueOf(this.instDtlsTpcd)).getInstCode()) {
			...
			default: this.cmpdMethod = CMPD_MTD_SIMP; break;
		}
	}
    ...
    protected void setPayoffAmount() throws Exception {
    	...
    	for(int i=0; i<payoffDate.length; i++) {
    		...
    		if(i == 0) {    			
    			...
    			this.notionalCurrent = this.notionalCurrent - principalPayoffAmount[i];
